...
\includegraphics[width=41mm,height=20mm]{fig4.png}}
\hfill
\qquad
\subfloat[One-to-one mapping.\label{4b}]{%
\includegraphics[width=41mm,height=20mm]{fig5.png}}
\hfill
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=80mm,height=30mm]{fig8.png}}
...
Table~\ref{tab1} summarizes the above calculation and shows resource consumption over 1000 packets of three schemes to achieve the same reliability.

\begin{table}[htbp]
\caption{Resource and latency comparison over 1000 packet}
\begin{center}
\begin{tabular}{ |p{4.6em}|p{2em}|p{2em}|p{2em}|p{2em}|p{2em}|p{2em}|p{2.8em}|}
 \hline
 \multirow{2}{6em}{} & \multicolumn{3}{p{6em}}{\textbf{$1^{st}$ transmission's success}}& \multicolumn{3}{|p{6em}|}{\textbf{$2^{nd}$ transmission's success}}& \multirow{2}{6em}{\textbf{Total resource (REs)}}\\\cline{2-7}
 &\textbf{Quant} & \textbf{Res (REs)}&\textbf{Lat (ms)}&\textbf{Quant} & \textbf{Res (REs)}&\textbf{Lat (ms)} \\
 \hline
 Conventional&$999$&$120$& $0.25$& $0$& $0$ & $0$ &$119880$\\
 \hline
 Prior art\cite{b3} and \cite{b4} &$860$&$80$& $0.25$& $139$& $120$ &  $0.5$&$96600$\\
  \hline
 Proposed scheme &$860$&$80$&$0.25$ & $139$& $40$ &  $0.5$&$85480$\\
