...
\begin{tabular}{ |p{4.6em}|p{2em}|p{2em}|p{2em}|p{2em}|p{2em}|p{2em}|p{2.8em}|}
 \hline
 \multirow{2}{6em}{} & \multicolumn{3}{p{6em}}{\textbf{$1^{st}$ transmission's success}}& \multicolumn{3}{|p{6em}|}{\textbf{$2^{nd}$ transmission's success}}& \multirow{2}{6em}{\textbf{Total resource}}\\\cline{2-7}
 &\textbf{Quant} & \textbf{Res (REs)}&\textbf{Lat (ms)}&\textbf{Quant} & \textbf{Res}&\textbf{Lat (ms)} \\
 \hline
